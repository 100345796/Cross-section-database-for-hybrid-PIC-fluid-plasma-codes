...
CODE DESCRIPTION: 
    ...
    rate for a specific reaction in an-anisotropic system
...
INPUTS REQUIRED:
    ...
    -Velocity_parallel: velocity of the flow of electrons in the parallel direction. In [eV]
    -Velocity_perpendicular: velocity of the flow of electrons in the perpendicular direction. In [eV]

OUTPUT:
    
    -The collision rate at the specified temperature. In [m^3/s]
"""
########### INPUTS REQUIRED ###########################
...
import db_codes
Collision_rate = db_codes.collision_rate_BiMaxwellian(Database_root, Type, specie1, specie2, process, file_name, Velocity_parallel, Velocity_perpendicular) #[m^3/s]
